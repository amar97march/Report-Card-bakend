...
class SchoolApi(APIView):
    ...
    def post(self,request):
        ...
        if not school:
            school = School(name = params['name'], established_date = parse_date(params['established_date']), school_id = params['school_id'], address = params['address'],principal = params['principal']).save()
...
class TeacherApi(APIView):
    ...
    def post(self, request):
        ...
        try:
            teacher = Teacher(teacher_name = params['teacher_name'], domain = params['domain'],appointed_date = params['appointed_date'],gender = params['gender'], school = school).save()
        except:
...
class StandardApi(APIView):
    ...
    def post(self, request):
        ...
        try:
            standard = Standard(div = params['div'],class_teacher = teacher, school = school).save()
        except:
...
class StudentApi(APIView):
    ...
    def post(self, request):
        ...
        try:
            student = Student(first_name = params['first_name'], last_name = params['last_name'],dob = params['dob'],father_name = params['father_name'],standard = standard, address = params['address']).save()
        except:
